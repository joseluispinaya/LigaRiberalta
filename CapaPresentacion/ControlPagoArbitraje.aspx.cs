...
{
    public partial class ControlPagoArbitraje : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static Respuesta<List<EquipoDeudorDTO>> EquiposDeudoresArbitraje(int IdTorneo, int IdCategoria, int IdFase)
        {
            return NResultados.GetInstance().EquiposDeudoresArbitraje(IdTorneo, IdCategoria, IdFase);
        }

        [WebMethod]
        public static Respuesta<bool> NotificacionCobroArbitraje(int idEquipo, string titulo, string mensaje, string informacion)
        {
            try
            {
        ...
        [WebMethod]
        public static Respuesta<bool> ActualizarPagoArbitraje(int IdPartido, int IdEquipo)
        {
            if (IdPartido <= 0 || IdEquipo <= 0)
            {
                return new Respuesta<bool>
                {
                    Estado = false,
            ...
            return NResultados.GetInstance().ActualizarPagoArbitraje(IdPartido, IdEquipo);
        }
