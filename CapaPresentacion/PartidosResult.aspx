<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster.Master" AutoEventWireup="true" CodeBehind="PartidosResult.aspx.cs" Inherits="CapaPresentacion.PartidosResult" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h1 class="page-header">PANEL DE PARTIDOS <small>Y RESULTADOS FASE DE GRUPOS</small></h1>
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse shadow-sm border-0">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title"><i class="fa fa-sitemap me-2"></i>Gestión de Partidos Programados Fase de Grupos</h4>
                </div>
                ...
                <div class="panel-body p-0">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-fill">
                                ...
                                <p class="mb-0 text-muted fs-13px">
                                    Seleccione el torneo y la categoría. La tabla se cargará automáticamente al elegir una serie.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 border-bottom bg-white">
                        <div class="row g-4 align-items-end">
                            ...
                            <!-- Columna 3: Serie -->
                            <div class="col-md-4">
                                <label class="form-label fw-bold text-dark mb-2" for="cboFiltroSerie">
                                    <i class="fa fa-list-ol text-success me-1"></i>Seleccione Serie:
                                </label>
                                <select id="cboFiltroSerie" class="form-select form-select-lg bg-light border-0 shadow-none cursor-pointer" disabled>
                                </select>
                            </div>
                    ...
                    <div class="p-4 bg-white">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <!-- Nuevo Botón alineado a la derecha -->
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="server">
    <script src="js/PartidoResult.js?v=<%= DateTime.Now.ToString("yyyyMMddHHmmss") %>" type="text/javascript"></script>
</asp:Content>
